...
export const ADMIN_DICT = {
  ms: {
    ...
    superAdminEmailLabel: 'E-mel Super Admin *',
    enterSuperAdminEmail: 'Masukkan e-mel super admin...',
    ...
    superAdminSetupSuccess: '✅ E-mel anda {email} telah didaftarkan sebagai E-mel Super Admin untuk sistem ini!',
    emailOrPasswordInvalid: 'E-mel atau kata laluan tidak sah.',
  ...
  en: {
    ...
    superAdminLoginHint: 'First time setup? Register your email and password.',
    ...
    enterSuperAdminEmail: 'Enter super admin email...',
    confirmPasswordLabel: 'Confirm Password *',
    enterConfirmPassword: 'Re-enter password...',
    setupSuperAdminBtn: '🚀 Create Super Admin Account',
    settingUp: 'Setting up...',
    superAdminSetupSuccess: '✅ Your email {email} has been registered as the Super Admin email for this system!',
