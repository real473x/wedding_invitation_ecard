...
export const ADMIN_DICT = {
  ms: {
    ...
    usersTab: '👥 Pengurusan Pengguna',
    storageTab: '💾 Storan & Reset System',
    ...
    addUserBtn: '＋ Tambah Pengguna Baru',
    addPayment: '＋ Rekod Bayaran',
    searchPlaceholder: '🔍 Cari nama, ID, lokasi...',
    userSearchPlaceholder: '🔍 Cari pengguna, peranan, ID...',
    accessEditor: 'Editor',
    resetPassword: 'Tukar Pass',
    delete: 'Padam',
    confirmDelete: 'Adakah anda pasti untuk memadam pasangan ini?',
    confirmDeleteUserPrompt: 'Adakah anda pasti untuk memadam akaun pengguna ini?',
    userRoleHeader: 'Peranan',
    usernameHeader: 'Nama Pengguna / Login ID',
    superAdminRole: '👑 Super Admin',
    coupleAdminRole: '💍 Admin Pasangan',
    createUserModalTitle: '➕ Cipta Pengguna Baru',
    editUserModalTitle: '✏️ Kemaskini Akaun Pengguna',
    selectRoleLabel: 'Peranan Pengguna *',
    storageStatusTitle: '⚡ Status Pangkalan Data & Storan',
    redisStatusLabel: 'Status Upstash Redis',
    dbJsonStatusLabel: 'Status Fail db.json Local/Vercel',
    connected: '🟢 Berhubung (Active)',
    notConnected: '🟡 Tidak Berhubung (Local Fallback)',
    fileExists: '📁 Fail Wujud',
    fileDeleted: '🗑️ Fail Telah Dipadam / Pure Redis',
    deleteDbJsonBtn: '🗑️ Padam db.json Local (Guna Vercel Redis Sahaja)',
    confirmDeleteDbJsonTitle: '⚠️ Padam Fail db.json Local?',
    confirmDeleteDbJsonDesc: 'Tindakan ini akan memadam fail db.json pada pelayan. Pastikan pangkalan data Vercel Redis anda telah aktif.',
    systemResetTitle: '🔥 Drop Process & Set Semula Sistem (Start from Scratch)',
    systemResetDesc: 'Padam semua pangkalan data (Redis & db.json), log keluar semua sesi pengguna, mengosongkan cache, dan memulakan semula sistem dari awal. Anda akan diminta mencipta Username & Password Super Admin baru.',
    systemResetBtn: '🔥 Drop Data & Set Semula Sistem',
    confirmResetPrompt: 'Sila taip RESET untuk mengesahkan pemadaman keseluruhan data sistem:',
    userDeletedToast: 'Pengguna berjaya dipadam!',
    userCreatedToast: 'Pengguna berjaya dicipta!',
    userUpdatedToast: 'Pengguna berjaya dikemaskini!',
    dbJsonDeletedToast: 'Fail db.json telah dipadam! Sistem kini mengguna Vercel Redis.',
    systemResetSuccessToast: 'Sistem telah di-set semula. Sila cipta akaun Super Admin baru.',
  ...
  en: {
    ...
    storageTab: '💾 Storage & Reset System',
    ...
    userSearchPlaceholder: '🔍 Search user, role, ID...',
    accessEditor: 'Edit Site',
    resetPassword: 'Reset Pass',
    delete: 'Delete',
    confirmDelete: 'Are you sure you want to delete this couple account?',
    confirmDeleteUserPrompt: 'Are you sure you want to delete this user account?',
    userRoleHeader: 'Role',
    usernameHeader: 'Username / Login ID',
    superAdminRole: '👑 Super Admin',
    coupleAdminRole: '💍 Couple Admin',
    createUserModalTitle: '➕ Create New User',
    editUserModalTitle: '✏️ Edit User Account',
    selectRoleLabel: 'User Role *',
    storageStatusTitle: '⚡ Database & Storage Status',
    redisStatusLabel: 'Upstash Redis Status',
    dbJsonStatusLabel: 'Local/Vercel db.json File Status',
    connected: '🟢 Connected (Active)',
    notConnected: '🟡 Not Connected (Local Fallback)',
    fileExists: '📁 File Exists',
    fileDeleted: '🗑️ File Purged / Pure Redis',
    deleteDbJsonBtn: '🗑️ Delete Local db.json (Use Pure Vercel Redis)',
    confirmDeleteDbJsonTitle: '⚠️ Delete Local db.json File?',
    confirmDeleteDbJsonDesc: 'This action will delete the db.json file on the server. Ensure your Vercel Redis database is active.',
    systemResetTitle: '🔥 Drop Process & Factory Reset System',
    systemResetDesc: 'Deletes all database data (Redis & db.json), logs out all user sessions, flushes caches, and restarts the system from scratch. You will be prompted to create a new Super Admin Username & Password.',
    systemResetBtn: '🔥 Drop Data & Reset System',
    confirmResetPrompt: 'Please type RESET to confirm dropping all system data:',
    ...
    dbJsonDeletedToast: 'db.json file deleted! System now uses Vercel Redis.',
    systemResetSuccessToast: 'System reset successfully. Please create a new Super Admin account.',
    coupleHeader: 'Couple',
    loginIdHeader: 'Login ID',
